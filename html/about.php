...
<div class="card-container row justify-content-around">
  ...
  <div class="card col-12 col-md-3" style="width: 18rem;">
    <img class="card-img-top card-pic" src="images/mrX.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Afortunada Persona</h5>
      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
      <a href="#" class="btn btn-primary ion-social-linkedin-outline"></a>
    </div>
  </div>
